...
public class BezierCurve implements Serializable {
    ...
    public final class ControlPoint implements Serializable{
        ...
        public void moveTo(int x, int y) {
            this.x = x;
            this.y = y;
            area = new Ellipse2D.Float(x - RADIUS / 2, y - RADIUS / 2, RADIUS, RADIUS);      
        }
    ...
    public StyledShape getPointsShape() {
        ...
        return new StyledShape(points, StyledShape.Style.basic);
    }

    public StyledShape getPolygonShape() {
        ...
        return new StyledShape(controlPolygon, StyledShape.Style.dashed);
    }

    public StyledShape getBezierShape() {
        ...
        return new StyledShape(bezierCurve, StyledShape.Style.basic);
    }
    ...
    private BezierCurve subdivision1(double t){
        //TODO
        if(!(t > 0 && t < 1)){
            return null;
        }
    ...
    public BezierCurve subdivision(double t){
        if(!(t > 0 && t < 1)){
            return null;
        }
        t = 1-t;
